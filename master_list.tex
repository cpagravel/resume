...
{%
  \resumeitem{%
    ...
    (Python, Geometry, Numerical Methods)
  }
  \resumeitem{%
...
{%
  \resumeitem{%
    ...
    (C++, Python, ROS, Matlab, Numerical Methods)
  }
  \resumeitem{%
...
\iftoggle{electrical}{%
  ...
  {%
    \resumeitem{%
      Optimized FPGA Ethernet receiver by reducing CPU read operations by 8x.
    }
    \resumeitem{%
      Automated testing using Python scripts to communicate with instruments
    }
  }
  \resumeitemendlist
...
% \iftoggle{software}{%
\ifboolexpr{ togl {software} or togl {allprojects} }{%
  \project{gst - (G)it (St)atus Tool}{Python}{2018}
  \resumeitemstartlist
  {%
    \resumeitem{%
